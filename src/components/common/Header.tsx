        ...
        <div className="flex items-center justify-between pt-6">
          ...
          <div
            className={`${nav && "max-lg:left-[-100%]"} ${
              !nav && "max-lg:start-0"
            } flex gap-8 z-10 max-lg:bg-white max-lg:flex-col max-lg:items-center max-lg:justify-center max-lg:fixed max-lg:w-full max-lg:h-full max-lg:top-0 transition-all ease-linear duration-300`}
          >
          ...
          <button className="font-jakarta font-semibold text-dark_red py-[10px] px-8 border border-dark_red rounded hover:bg-dark_red hover:text-white transition duration-300 ease-linear max-lg:hidden">
            Start Building
          </button>
        </div>
      </div>
